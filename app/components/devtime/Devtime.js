...
export default class Devtime extends React.Component {
  ...
  getTitle(time) {
    ...
    let _title = this.format(time) + ' | devtime timer';
    return _title;
  }
  ...
  _setLocalStorage (item, element) {
    ...
    localStorage.setItem('react-devtime-' + item, value);
  }

  _getLocalStorage (item) {
    return (localStorage.getItem('react-devtime-' + item) == 'true') ? true : false;
  }
  ...
  render() {
    ...
    return (
      <div className="devtime">
        <GithubCorner
          href="https://github.com/vpdeva/react-devtime"
          bannerColor="#2BA0A0"
          octoColor="#272727"
        />
          ...
          <div className="controls">
            <div className="container">
              ...
              <div className="controlsLink">
                <a href="https://en.wikipedia.org/wiki/devtime_Technique" target="_blank">What is devtime?</a>
              </div>
